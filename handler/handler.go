...
func (th tokenHandler) GenerateToken(authCode chan string) {
	apiScopes := map[string][]string{
		...
		"document": {docs.DocumentsScope, docs.DocumentsReadonlyScope, drive.DriveScope, drive.DriveReadonlyScope},
		"people":   {people.DirectoryReadonlyScope, people.ContactsReadonlyScope},
	}
